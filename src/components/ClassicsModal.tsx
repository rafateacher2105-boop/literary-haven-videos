  ...
  { title: "Heróis Épicos: Rostan — O Escudo Indestrutível da Pérsia, Livro XVII", author: "Rafael S. L. Aguiar", cover: coverRostan, description: "Edição de Luxo dedicada a Rostan, o maior herói da antiga Pérsia, imortalizado no Shahnameh. Vestido com o manto de pele de tigre (babr-e bayan) e empunhando seu escudo indestrutível e a maça pesada (gorz), ele cavalga o lendário corcel Rakhsh por desertos, montanhas e ruínas de Persépolis. Enfrenta os Sete Trabalhos (Haft Khan), o Div Branco, dragões e exércitos inteiros para defender o trono persa e seu povo. Entre a honra do guerreiro, a tragédia do duelo com Sohrab e a fidelidade ao reino, esta é a saga do escudo que jamais se rompeu. Edição e adaptação de Rafael S. L. Aguiar para a série Heróis Épicos — Livro XVII. Curadoria Letras e Páginas." },
   ...
   { title: "Heróis Épicos: Mulan — Família, Honra e Lealdade, Livro XXI", author: "Rafael S. L. Aguiar", cover: coverMulan, file: "/books/mulan-familia-honra-lealdade.pdf", description: "Edição de Luxo em aquarela serigrafada dedicada a HUA MULAN, a heroína imortal da China antiga. Quando o imperador convoca todas as famílias para a guerra contra os invasores do norte e seu pai idoso é chamado às armas, Mulan corta os longos cabelos, veste a armadura e parte em seu lugar — disfarçada de homem, montada em seu cavalo de batalha. Por doze anos serve nos exércitos imperiais sem que ninguém descubra seu segredo, conquistando vitórias, lealdade e a admiração dos generais. Quando lhe oferecem títulos e cargos no palácio, ela pede apenas um cavalo veloz para voltar para casa. Esta é a saga de coragem, devoção filial e fidelidade que atravessou os séculos desde a Balada de Mulan até os dias de hoje — o coração de uma mulher que carregou a honra de uma família inteira. Edição e adaptação de Rafael S. L. Aguiar para a série Heróis Épicos — Livro XXI. Curadoria Letras e Páginas." },
    { title: "Heróis Épicos: Atalanta — Uma Flecha de Ouro, Livro XX", author: "Rafael S. L. Aguiar", cover: coverAtalanta, file: "/books/atalanta-flecha-de-ouro.pdf", description: "Edição de Luxo em aquarela serigrafada dedicada a ATALANTA, a mais veloz das heroínas gregas. Abandonada ao nascer por ser mulher, é amamentada por uma ursa e criada por caçadores nas florestas da Arcádia, tornando-se a melhor arqueira de seu tempo. Sob a proteção de Ártemis, fere de morte o monstruoso Javali de Cálidon, vence os heróis na luta livre durante os jogos fúnebres de Pélias, embarca com os Argonautas em busca do Velocino de Ouro e desafia todos os pretendentes a uma corrida fatal — até que três maçãs douradas de Afrodite, lançadas por Hipômenes, decidem seu destino. Esta é a saga da mulher que correu mais que o vento e cuja flecha de ouro atravessou a própria mitologia. Edição e adaptação de Rafael S. L. Aguiar para a série Heróis Épicos — Livro XX. Curadoria Letras e Páginas." },
     ...
     { title: "Heróis Épicos: Bradamante — A Dama de Prata, Livro XXIV", author: "Rafael S. L. Aguiar", cover: coverBradamante, file: "/books/bradamante-dama-de-prata.pdf", description: "Edição Premium em aquarela serigrafada dedicada a BRADAMANTE, a lendária donzela-cavaleira da matéria carolíngia, imortalizada nos versos de Boiardo (Orlando Innamorato) e Ariosto (Orlando Furioso). Irmã de Rinaldo e prima de Orlando, vestindo armadura de prata reluzente e empunhando a lança encantada de ouro que derrubava qualquer cavaleiro com um único toque, ela cavalga pelos campos da França de Carlos Magno enfrentando sarracenos, magos e monstros para defender a cristandade. Apaixonada pelo nobre cavaleiro mouro Rugiero — convertido por amor —, ela atravessa florestas encantadas, cavernas de feiticeiros, o castelo de Atlante, ilhas mágicas e duelos com o hipogrifo, sempre fiel à promessa de unir-se ao amado e fundar a casa de Este. Esta é a saga da Dama de Prata: a mulher que cavalgou entre paladinos como igual, cuja honra brilhava como o aço de sua armadura e cujo coração foi o farol que guiou um cavaleiro até a luz. Adaptação de Rafael S. L. Aguiar — Edição Premium da série Heróis Épicos — Livro XXIV. Curadoria Letras e Páginas." },
     { title: "Heróis Épicos: Sir Roland — O Cavaleiro do Escudo de Prata, Livro XXVI", author: "Rafael S. L. Aguiar", cover: coverSirRoland, file: "/books/sir-roland-cavaleiro-escudo-prata.pdf", description: "Edição Premium em aquarela serigrafada dedicada a SIR ROLAND, o lendário cavaleiro do escudo de prata, paladino fiel da corte de Carlos Magno e herói imortal da matéria carolíngia. Empunhando sua espada Durindana — forjada com aço celestial e nunca derrotada em combate —, montado em seu fiel corcel Veillantif e portando o reluzente escudo de prata que refletia a luz do sol como um espelho divino, Roland cavalga pelos reinos da França medieval enfrentando exércitos sarracenos, gigantes, traidores e feiticeiros para defender a cristandade e a honra do imperador. Da defesa heroica do desfiladeiro de Roncesvales contra hordas inimigas, ao toque desesperado do olifante que ecoou pelos vales dos Pirineus chamando Carlos Magno em socorro, esta é a saga de lealdade, fé e sacrifício de um cavaleiro cuja coragem brilhou como o próprio escudo que carregava — um símbolo eterno da cavalaria que jamais se curva diante do mal. Adaptação de Rafael S. L. Aguiar — Edição Premium da série Heróis Épicos — Livro XXVI. Curadoria Letras e Páginas." },
     { title: "Heróis Épicos: Tristão — A Balada de Tristão, Livro XXVII", author: "Rafael S. L. Aguiar", cover: coverTristao, file: "/books/tristao-balada.pdf", description: "Edição Premium em aquarela serigrafada dedicada a TRISTÃO, o nobre cavaleiro celta da corte do rei Marcos da Cornualha, herói imortal da matéria da Bretanha e protagonista de uma das mais belas e trágicas baladas da literatura medieval. Guerreiro invencível de espada reluzente e harpa encantada, Tristão venceu o gigante Morholt da Irlanda em combate singular, libertando o reino do tributo cruel, e atravessou mares tempestuosos em busca da princesa Isolda dos Cabelos de Ouro. Mas o destino reservou-lhe a poção do amor eterno — um filtro mágico que selou seu coração ao da rainha em uma paixão proibida, mais forte que a honra, a lealdade ao rei e a própria morte. Entre torneios, cavalgadas pelas florestas da Cornualha, exílios na Bretanha e o canto melancólico de sua harpa ecoando pelos penhascos do mar, esta é a balada de um cavaleiro cuja espada jamais conheceu derrota, mas cujo coração foi vencido pelo mais doce e fatal dos amores. Adaptação de Rafael S. L. Aguiar — Edição Premium da série Heróis Épicos — Livro XXVII. Curadoria Letras e Páginas." },
     { title: "Heróis Épicos: Dante — A Busca por Beatrice, Livro XXV", author: "Rafael S. L. Aguiar", cover: coverDante, file: "/books/dante-busca-por-beatrice.pdf", description: "Edição Premium ilustrada em aquarela dedicada a DANTE ALIGHIERI, o Poeta Supremo de Florença, e à sua imortal amada BEATRICE PORTINARI — a musa luminosa que transformou um amor terreno em jornada divina. Esta adaptação narra a saga do jovem Dante, exilado de sua amada cidade, vagando pelos círculos do Inferno guiado pelo sábio Virgílio, escalando a montanha do Purgatório e ascendendo às esferas celestes do Paraíso ao encontro de Beatrice — coroada de luz, envolta em rosas e estrelas, símbolo do Amor que move o sol e as demais estrelas. Entre demônios, anjos, almas penitentes e visões beatíficas, Dante atravessa o universo medieval em busca da redenção, da verdade e do reencontro eterno com a mulher que iluminou sua vida. Esta é a saga do peregrino do amor: o homem que fez da poesia uma escada até o céu e da saudade um caminho até Deus. Adaptação de Rafael S. L. Aguiar — Edição Premium da série Heróis Épicos — Livro XXV. Curadoria Letras e Páginas." },
  ];
