...
const talesBooks: ClassicBook[] = [
  ...
  { title: "Heróis Épicos: Aquiles — A Ira do Herói de Troia", author: "Rafael S. L. Aguiar", cover: coverAquiles, file: "https://drive.google.com/drive/folders/1O4xlG7fNMagIv_Mp2WhCN6hxeVDr2XLn", description: "A saga do maior guerreiro da Guerra de Troia. Acompanhe Aquiles em sua jornada épica: a fúria contra Agamenon, a perda de Pátroclo, o duelo lendário com Heitor e o destino traçado pelos deuses. Edição ilustrada de luxo da série Heróis Épicos. Curadoria Letras e Páginas." },
