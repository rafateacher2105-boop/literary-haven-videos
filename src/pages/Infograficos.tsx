  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <link rel="canonical" href="https://letrasepaginas-blog.lovable.app/infograficos" />
        ...
        <meta property="og:url" content="https://letrasepaginas-blog.lovable.app/infograficos" />
